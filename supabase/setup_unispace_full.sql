...
BEGIN
  ...
  INSERT INTO public.profiles (id, email, full_name, role, status, phone, department, profile_id)
  VALUES (
    NEW.id,
    NEW.email,
...
BEGIN
  ...
  INSERT INTO public.profiles (id, email, full_name, role, status, profile_id, phone, department)
  VALUES (
    v_admin_id,
    'mdjakaria111016@gmail.com',
    'Admin User',
